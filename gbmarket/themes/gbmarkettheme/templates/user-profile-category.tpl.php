...
?>
<?php
  // These classes aren't being rendered in the $attributes for some reason.
  $new_classes = implode(' ',$variables['element']['#attributes']['class']);
?>
<?php if ($title): ?>
  <h3><?php print $title; ?></h3>
<?php endif; ?>
<ul class="user-profile-category <?php print $new_classes; ?>">
